...
<!--
	...
	<div class="property-results">
		...
		?>
			...
			<!-- 				<div class="et_pb_column et_pb_column_1_3 single_property">
								...
								<div class="property-box card">
									...
									<?php// if (has_post_thumbnail( $post->ID ) ): ?>
										...
										<div class="property-image" style="background-image: url(<?php// echo $image[0]; ?>);">

											<div class="price_icons">

												<div class="icons primary-bg-color">

													<div class="icon"><i class="fa fa-bed" aria-hidden="true"></i><p><?php// echo $bedrooms; ?></p></div>

													<div class="icon"><i class="fa fa-bath" aria-hidden="true"></i><p><?php// echo $bathrooms; ?></p></div>

													<div class="icon"><img src="<?php// echo site_url(); ?>/wp-content/themes/YOP%20Properties/templates/Roberts/assets/img/sofa.png"><p><?php //echo $receptionrooms; ?></p></div>
									...
									<?php //else: ?>
										...
										<div class="property-image" style="background-image: url(http://placehold.it/1000);"></div>
									...
									<div class="property-content">
										...
										<p class="price">£<?php// echo number_format($price); if ($selling_type == "for-rent") { echo " PCM";}?></p>

										<p><?php //echo substrwords($content,170, "..."); ?></p>

										<a class="button animated-button primary-bg-color secondary-bg-color-after" href="<?php //site_url(); ?>/property-details/?property_id=<?php //echo get_the_ID(); ?>"><span>Full Details</span></a>

										<?php //if ($profile_enabled == 1): ?>

											<?php //if (is_user_logged_in()) { ?>

												<a class="button secondary-bg-color animated-button primary-bg-color-after save_property" href="#"><span>Save Property</span></a>

											<?php // } else { ?>

												<a class="button secondary-bg-color animated-button primary-bg-color-after login_button" href="#"><span>Save Property</span></a>

											<?php // } ?>

											<div class="hide post_user"><?php// echo $user_id ?></div>

											<div class="hide post_id"><?php //echo $post->ID ?></div>

											<div class="hide post_name"><?php //echo $name ?></div>

											<div class="hide post_price"><?php// echo number_format($price); if ($selling_type == "for-rent") { echo " pcm";} ?></div>

											<div class="hide post_photo">
			...
			<?php
				...
				// $loop_number = $per_page * $page;

				// $loop_number_end = $loop_number - $per_page;

				//  	foreach($url_data->property as $property) {



				//  		if ($loop_number <= $per_page ) {



				// 	 		if ($loop_times < $loop_number ) {
				...
				// 				$address4 = $property->addressPostcode ;

				// 				$address5 = $property->country ;

				// 				$property_image = $property->images->children()[0] ;
				...
				// 						$save = '<div class="save-button" id="save-button'.$property_id.'" name="save-button"><a class="btn waves-effect blue save_property">Save</a>



				// 						<input type="hidden" class="property-name"  value="'.$property_name.'">

				// 						<input type="hidden" class="property-price"  value="'.$price_2.'">

				// 						<input type="hidden" class="property-img"  value="'.$property_image.'">

				// 						<input type="hidden" class="property-number"  value="'.$property_id.'">
				...
				// 						$save = '<button class="btn waves-effect blue save_property" disabled>SAVED</button>';
				...
				// 				$save = '<a class="btn waves-effect blue save-button register-toggle-popup">Save</a>';
				...
				// 								<div class="property_image" style="background-image: url('.$property_image.')"></div>

				// 								<div class="property_content">

				// 									<h2 class="title">'.$property_name .'</h2>

				// 									<h3 class="price">£'.$price_2.'</h3>

				// 									<p class="description">'. $short_description .'</p>

				// 									<a href="/property-details/?id='.$property_id.'" class="btn waves-effect pink-outline">Details</a>
				...
				// 	 		if ($loop_times <= $loop_number_end ) {



				// 				$loop_times++;

				// 	 		} else if ($loop_times <= $loop_number ){
				...
				// 				// $property_image = $pro  perty->images->image[0];
				...
				// 				$save = '<a class="btn waves-effect blue save_property">Save</a>
				...
				// 				<input type="hidden" class="property-number"  value="'.($what_property + 1).'">
				...
				// 				$save = '<a class="btn waves-effect blue register-toggle-popup">Save</a>';
				...
				// 									<a href="/property-details/?id='.($what_property + 1).'" class="btn waves-effect pink-outline">Details</a>
